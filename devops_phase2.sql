-- สร้างฐานข้อมูลใหม่
CREATE DATABASE devops_phase2;
USE devops_phase2;
-- drop database devops_phase2; --  
...
--   `currency_code`, `exchange_rate`, `paid_by_user_id`,
--   `promptpay_number`, `receipt_image_url`, `split_method`, `bill_date`
-- ) VALUES (
--   1,
--   'Dinner at KFC',
--   'Dinner with group at Central World',
--   25.00,
--   'USD',
--   36.50,
--   1,
--   '0812345678',
--   'https://firebasestorage.googleapis.com/v0/b/.../receipt.jpg',
--   'equal',
--   '2025-11-12 19:00:00'
-- );
